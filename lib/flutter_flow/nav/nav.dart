...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'getstrated',
          path: '/getstrated',
          builder: (context, params) => const GetstratedWidget(),
        ),
        FFRoute(
          name: 'Auth1',
          path: '/auth1',
        ...
        FFRoute(
          ...
          path: '/seller',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'seller')
              : const SellerWidget(),
        ),
        FFRoute(
          name: 'video',
        ...
        FFRoute(
          name: 'rates',
          path: '/rates',
          builder: (context, params) => const RatesWidget(),
        ),
        FFRoute(
          name: 'buy',
          path: '/buy',
          builder: (context, params) =>
              params.isEmpty ? const NavBarPage(initialPage: 'buy') : const BuyWidget(),
        ),
        FFRoute(
          name: 'profiles',
          path: '/profiles',
        ...
        FFRoute(
          name: 'agriproduct',
          path: '/agriproduct',
          builder: (context, params) => const AgriproductWidget(),
        ),
        FFRoute(
          name: 'uu',
          path: '/uu',
          builder: (context, params) => const UuWidget(),
        ),
        FFRoute(
          name: 'fff',
          path: '/fff',
          builder: (context, params) => const FffWidget(),
        )

...
class _SellerWidgetState extends State<SellerWidget> {
  ...
  void initState() {
    ...
    _model.enterquantityTextController ??= TextEditingController();
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            FlutterFlowDropDown<String>(
                              ...
                              options: const ['Crop', 'Vegetable', 'Fruits'],
                            ...
                            SizedBox(
                              width: MediaQuery.sizeOf(context).width * 1.0,
                              child: TextFormField(
                                controller: _model.enterquantityTextController,
                                ...
                                validator: _model
                                    .enterquantityTextControllerValidator
                                    .asValidator(context),
                              ),
                            ),
                            SizedBox(
                  ...
                  FFButtonWidget(
                    onPressed: () async {
                      await SellerRecord.collection.doc().set({
                        ...createSellerRecordData(
                          price:
                              double.tryParse(_model.priceTextController.text),
                          quantity: int.tryParse(
                              _model.enterquantityTextController.text),
